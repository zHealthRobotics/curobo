...
.. code-block:: bash
   ...
   python -m curobo.examples.getting_started.reactive_control --visualize --robot minibot_dual_arm.yml
...
def interactive_mpc_example(robot_file="minibot_dual_arm.yml", port=8080):
...
def main():
    ...
    parser.add_argument(
        "--robot", type=str, default="minibot_dual_arm.yml", help="Robot config file (default: minibot_dual_arm.yml)",
    )
    parser.add_argument(
